        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="room-details-item">
                    <img src="${THE_ROOM_DETAIL.img}" alt="">
                    <div class="rd-text">
                        <div class="rd-title">
                            <h3>${THE_ROOM_DETAIL.name}</h3>
                            <div class="rdt-right">
                                <div class="rating">
                                    <i class="icon_star"></i>
                                    <i class="icon_star"></i>
                        ...
                        <h2>${THE_ROOM_DETAIL.price}<span>/Pernight</span></h2>
                        <table>
                            <tbody>
                            <tr>
                        ...
                        <p class="f-para">Description :<br/><br/>
                            ${THE_ROOM_DETAIL.description}
                        </p>
